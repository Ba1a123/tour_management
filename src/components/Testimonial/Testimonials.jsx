    ...
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        ...
        <div className="d-flex align-items-center gap-4 mt-3">
          <img src="/images/ava-1.jpg" className="w-25 h-25 rounded-2" alt="" />
          <div>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="d-flex align-items-center gap-4 mt-3">
          <img src="/images/ava-2.jpg" className="w-25 h-25 rounded-2" alt="" />
          <div>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <div className="d-flex align-items-center gap-4 mt-3">
          <img src="/images/ava-3.jpg" className="w-25 h-25 rounded-2" alt="" />
          <div>
            <h6 className="mb-0 mt-3">John Doe</h6>
            <p>Customer</p>
          </div>
